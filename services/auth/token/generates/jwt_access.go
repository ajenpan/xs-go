...
// func (a *JWTAccessGenerate) Token(ctx context.Context, data *token.GenerateBasic, isGenRefresh bool) (string, string, error) {
// 	claims := &JWTAccessClaims{
// 		StandardClaims: jwt.StandardClaims{
// 			Audience: data.UserInfo.Name,
// 			// Subject:   "",
// 			ExpiresAt: data.CreateAt.Add(data.ExpiresIn).Unix(),
// 		},
// 	}
